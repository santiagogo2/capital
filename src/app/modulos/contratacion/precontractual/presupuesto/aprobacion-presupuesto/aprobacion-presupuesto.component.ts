...
@Component({
	selector: 'app-aprobacion-presupuesto',
	templateUrl: './aprobacion-presupuesto.component.html',
	styles: []
})
export class AprobacionPresupuestoComponent implements OnInit {
	...
	*/
	cancelarSolicitud() {
		this._router.navigate(['./contratacion/precontractual/panel-presupuesto']);
	}
